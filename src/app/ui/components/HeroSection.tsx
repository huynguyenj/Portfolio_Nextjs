...
export default function HeroSection() {
  ...
  return (
    <motion.section
      ...
      className="flex flex-col sm:flex-row items-center px-5 h-[85vh] mt-15"
    >
      <div className="w-[100%] sm:w-[50%] lg:ml-20 mx-auto mt-10 sm:-mt-20">
        ...
        <div className="text-[1.5em] lg:text-4xl mb-3 flex overflow-hidden h-[1.3em] lg:h-[1.2em] gap-4">
          ...
          >
            {listText.map((word, i) => (
              <div key={i} className="h-[1em] mb-2">
                {word}
              </div>
            ))}
          </div>
        ...
        <p className="text-[1.1rem]">
          I am a passion person in coding and ready to learn, adapt any tech,
          environments. Having experience in building website and using many
          frameworks like: Reactjs, Nextjs. Always be ready for any situations.
        </p>
      </div>
